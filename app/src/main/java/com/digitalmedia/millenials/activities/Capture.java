...
public class Capture extends AppCompatActivity {
                ...
                if (DownloadManager.ACTION_DOWNLOAD_COMPLETE.equals(action)) {
                    ...
                    if (c.moveToFirst()) {
                        ...
                        if (DownloadManager.STATUS_SUCCESSFUL == c.getInt(columnIndex)) {
                            ...
                            SharedPreferences collections = getSharedPreferences("collections", MODE_PRIVATE);
                            ArrayList<HashMap<String, String>> arrayList = new ArrayList<HashMap<String, String>>();
                            HashMap<String, String> hashMap = new HashMap<String, String>();
                            hashMap.put("artist", getIntent().getStringExtra("artist"));
                            hashMap.put("title", getIntent().getStringExtra("title"));
                            hashMap.put("lyrics", getIntent().getStringExtra("lyrics"));
                            hashMap.put("image_link", getIntent().getStringExtra("image_link"));
                            hashMap.put("note", getIntent().getStringExtra("note"));
                            hashMap.put("path", uriString);
                            ...
                            collections.edit().putString("collections"+collections.getAll().size(), json).apply();
    ...
    public void playAudio(){
        ...
        intent.putExtra("play_last_download", true);
